...
namespace GlennisRecipeRepoApp.Controllers
{
    public class FeedbacksController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,RecipeId,UserName,Comment,Rating")] Feedback feedback)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,UserName,Comment,Rating")] Feedback feedback)
        {
            if (id != feedback.Id)
            {
                return NotFound();
